...
package applab.client.farmerlink.database;
 ...
 * </p>
 */
public abstract class MarketLinkSQLiteOpenHelper {
    private static final String t = MarketLinkSQLiteOpenHelper.class.getSimpleName();
     ...
     */
    public MarketLinkSQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
        if (version < 1)
