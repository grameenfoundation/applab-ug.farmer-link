...
public class HttpHelpers {
     ...
     * @param headers
     *            is a list of http headers that you may want to pass to the server. You can pass null if you do not
    ...
    public static InputStream postJsonRequestAndGetStream(String url,
        ...
        return postDataRequestAndGetStream(url, stringEntity, "application/json");
    }
    ...
    public static InputStream postJsonRequestAndGetStream(String url,
        ...
        return postDataRequestAndGetStream(url, stringEntity, "application/json", networkTimeout);
    }
    ...
    public static InputStream postDataRequestAndGetStream(String url, StringEntity stringEntity, String contentType) throws IllegalStateException, ClientProtocolException, IOException {
        HttpParams httpParameters = HttpHelpers.getConnectionParameters();
    ...
    public static InputStream postDataRequestAndGetStream(String url, StringEntity stringEntity, String contentType, int networkTimeout) throws IllegalStateException, ClientProtocolException, IOException {
