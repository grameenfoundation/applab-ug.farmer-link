...
public abstract class DashboardActivity extends Activity {
	...
	public void onClickFeature(View v) {
		...
		switch (id) {
		case R.id.selling:
			Intent sellingIntent = new Intent(getApplicationContext(),
					FindFarmersActivity.class);
			sellingIntent.putExtra("selectedOption", "selling");
			startActivity(sellingIntent);
			break;
		case R.id.buying:
			Intent buyingIntent = new Intent(getApplicationContext(),
					FindFarmersActivity.class);
			buyingIntent.putExtra("selectedOption", "buying");
		...
		case R.id.synch:
        	...
        	if (success == -1) {
        		...
        		toast("Synchronization failed, try again later");
        	}
			break;
		case R.id.history:
			startActivity(new Intent(getApplicationContext(),
